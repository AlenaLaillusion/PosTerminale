...
В корне проекта необходимо создать папку с названием `key`, затем через Git Bash перейти в эту папку, выполнив команду:
```bash
cd /d/EDI/EDI/learning/posTerminale/key
